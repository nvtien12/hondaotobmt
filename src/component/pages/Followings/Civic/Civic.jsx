        ...
        <img className="img" src="../assets/civic/honda-civic-banner-m4okjgrk.png" alt="banner" />
            ...
            <div className="card-img-overlay">
              <div className='text-civic'>
                ...
                <h4 className='text-card'>KIẾN TẠO CHUẨN MỰC HOÀN HẢO
                </h4>
              
                <p className="card-text">Tách mình khỏi những chuẩn mực cố định, Honda Civic chuyển mình để bứt phá trong từng đường nét <br/>thiết kế và tính năng, kiến tạo nên những thành công mới cho chủ sở hữu</p>
                    </div>    
            </div>
            </div>
